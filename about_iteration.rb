...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # SF: Assigns the starting value (x) to the accumulator |:accumulator, :item|
    # and stores successive values of the binary operation into this
    # accumulator. Returns the value of the accumulator.
  end
